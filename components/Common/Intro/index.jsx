...
import { FaDownload, FaFacebook, FaGithub, FaLinkedin, FaWhatsapp } from 'react-icons/fa';
...
import Sandeep from '../../../public/images/sandeep-profile.jpg';
  ...
  return (
    <>
      ...
      <div className='headerr z-50 absolute bg-MidNightBlack backdrop-blur-sm inset-y-0 h-48 top-0 flex items-center justify-center w-full flex-col px-4 gap-y-4'>
        <Image className='w-20 h-20 rounded-full' style={{ objectFit: 'contain', backgroundColor: '#879199ff' }} src={Sandeep} alt='profile picture' />
      ...
      <div className='footer absolute flex justify-center space-x-6 text-xl items-center bottom-0 z-50 h-10 w-full bg-MidNightBlack text-Snow'>
        ...
        <Link href={'https://wa.link/llofle'} target='_blank' rel='noreferrer' className=''>
          <FaWhatsapp />
        </Link>
      </div>
    </>
