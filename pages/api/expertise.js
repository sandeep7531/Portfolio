const expertise = [
    {
        ...
        desc: "I'm a skilled Front-end developer proficient in React.js, Next.js, and various UI frameworks like Material-UI, Ant Design, and Tailwind CSS. With expertise in JavaScript and TypeScript, I specialize in crafting responsive, performant web applications. I focus on user-centric design, efficient state management, and server-side rendering to deliver high-quality solutions tailored to client needs.",
    },
    {
        id: 1,
